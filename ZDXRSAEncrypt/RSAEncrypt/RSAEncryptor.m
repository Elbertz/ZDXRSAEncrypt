...
//  RsaTest
//
//  Created by wondertek  on 16/7/30.
...
//业务调用
+(NSString *)rsaEncrypt:(NSString *)inputStr
{
    NSString *private_key_path = [[NSBundle mainBundle] pathForResource:@"private_key.p12" ofType:nil];
    
//    NSString *encryptStr = [RSAEncryptor encryptString:inputStr publicKeyWithContentsOfFile:private_key_path];
    NSString *encryptStr = [RSAEncryptor encryptStringByPrivateKey:inputStr publicKeyWithContentsOfFile:private_key_path withPassword:@"123456"];
...
//加密
+ (NSString *)encryptStringByPrivateKey:(NSString *)str publicKeyWithContentsOfFile:(NSString *)path withPassword:(NSString *)password{
    if (!str || !path)  return nil;
...
+ (NSData *)encryptDataByPrivateKey:(NSData *)data withKeyRef:(SecKeyRef) keyRef{
...
+(NSString *)signTheDataSHA1WithRSA:(NSString *)plainText
{
    ...
    NSString * path = [[NSBundle mainBundle]pathForResource:@"lb_rsa_private_key.p12" ofType:nil];
    ...
    //    sanityCheck = SecKeyRawVerify (privateKeyRef,
    //                              kSecPaddingPKCS1SHA1,
    //                              hash,
    //                              20,
    ...
    NSString *signatureResult=[NSString stringWithFormat:@"%@",[signedHash base64EncodedStringWithOptions:NSDataBase64Encoding64CharacterLineLength]];
